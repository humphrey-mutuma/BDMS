...
//An if-else statement to display different messages after the Donors info is submitted to the Database.
        if($lastInsertId)
        {
        $msg="Your info submitted successfully"; // Message displayed after a successful submission of data to the Database.
        }
        else
        {
        $error="Something went wrong. Please try again"; //Message displayed after unsuccessful submission of data to the Database
        }
